...
class PurchaseBook(models.AbstractModel):
    _inherit = 'report.locv_fiscal_book.report_fiscal_purchase_book'
...
class FiscalBookSaleReport(models.AbstractModel):
    _inherit = 'report.locv_fiscal_book.report_fiscal_sale_book'
        ...
        for line in fbl_obj:
            if line:
                ...
                docs.append({
                    ...
                    'partner_vat': line.invoice_id.partner_id.vat if line.invoice_id.partner_id.vat else line.partner_vat,
