...
class TxtIva(models.Model):
    ...
    def action_generate_lines_txt(self):
        ...
        if txt_brw.type:
            vouchers = voucher_obj.search([
                ...
                ('wh_lines.invoice_id.state', '=', 'posted'),
                ('state', '=', 'done'),
    ...
    def get_amount_line(self, txt_line, amount_exempt, alicuota):
        ...
        total = (txt_line.untaxed + ((txt_line.untaxed * alicuota)/100)+amount_exempt)
    ...
    def get_amount_exempt_document(self, txt_line):
        ...
        amount_doc = 0
        print("///////// self  ",self,"  /////////")
        print("///////// parámetro txt_line  ",txt_line,"  /////////")
        print("///////// txt_line.voucher_id ",txt_line.voucher_id,"  /////////")
        print("///////// txt_line.voucher_id.wh_lines ",txt_line.voucher_id.wh_lines,"  /////////")
        print("///////// txt_line.voucher_id.wh_lines.tax_line ",txt_line.voucher_id.wh_lines.tax_line,"  /////////")
